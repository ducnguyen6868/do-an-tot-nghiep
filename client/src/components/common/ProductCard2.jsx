            ...
            <div className="border-b border-gray-100">
                <div className="flex items-start justify-between mb-3">
                    <div>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg mb-1 translate-x-8 animate-fadeInUp">{product.name}</h3>
            ...
            <div className="flex-1 space-y-4">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-3 bg-gradient-to-br from-cyan-50 to-blue-50 rounded-lg border border-cyan-200">
                        <div >
                            <img className='w-10' src={`http://localhost:5000${product.images[selectedIndex]}`} alt='Product' title='Product' />
                        </div>
