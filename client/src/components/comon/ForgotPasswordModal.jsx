        ...
        <div className="forgot-password-overlay" onClick={onClose}>
            <div className="forgot-password-modal" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className="form-group">
                                ...
                                <div className="otp-input-container">
                                    ...
                                    <div className="otp-timer">
                                        <Icon icon="mdi:timer-sand" width="16" height="16" />
                                ...
                                <div className="password-requirements">
                                    ...
                                    <div className="requirements-list">
                                        <div className={`requirement-item ${password.newPassword?.length >= 8 ? 'met' : ''}`}>
                                            <Icon icon={password.newPassword?.length >= 8 ? "mdi:check-circle" : "mdi:circle-outline"} width="16" height="16" />
                                            <span>At least 8 characters</span>
                                        </div>
                                        <div className={`requirement-item ${/[A-Z]/.test(password.newPassword) ? 'met' : ''}`}>
                                            <Icon icon={/[A-Z]/.test(password.newPassword) ? "mdi:check-circle" : "mdi:circle-outline"} width="16" height="16" />
                                        ...
                                        <div className={`requirement-item ${/[0-9]/.test(password.newPassword) ? 'met' : ''}`}>
                                            <Icon icon={/[0-9]/.test(password.newPassword) ? "mdi:check-circle" : "mdi:circle-outline"} width="16" height="16" />
                ...
                <div className="modal-trust">
                    ...
                    <div className="trust-item">
                        <Icon icon="mdi:account-check" width="16" height="16" />
